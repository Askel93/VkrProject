...
const MenuIcon = memo(({ style = {} }: { style?: CSSProperties }) => (
  <svg style={style} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-list" viewBox="0 0 14 14">
    <path fillRule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z" />
  </svg>));

const SearchIcon = memo(() => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-search m-auto" viewBox="0 0 16 16">
    <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z" />
  </svg>));

const TrushIcon = memo(() => (
  <svg width="1em" height="1em" viewBox="0 0 16 16" className="m-auto bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
    <path fillRule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z" />
  </svg>));

const EditIcon = memo(() => (
  <svg width="1em" height="1em" viewBox="0 0 16 16" className="m-auto bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
    <path fillRule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
  </svg>));

const CreateIcon = memo(() => (
  <svg width="1em" height="1em" viewBox="0 0 16 16" className="m-auto bi bi-plus-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const DownloadIcon = memo(() => (
  <svg width="1em" height="1em" viewBox="0 0 16 16" className="m-auto bi bi-download" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const PersonIcon = memo(() => (
  <svg width="30px" height="20px" viewBox="0 0 16 16" className="m-auto bi bi-person" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const EmailIcon = memo(() => (
  <svg width="30px" height="20px" viewBox="0 0 16 16" className="bi bi-at" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const PwdIcon = (): [boolean, () => JSX.Element] => {
  ...
  const Icon = () => {
    return (
      <>
        {show
          ?
          <div data-toggle="tooltip" data-placement="top" title="Hide password" style={{ display: 'flex' }}>
            <svg onClick={() => setShow(false)} width="30px" height="20px" viewBox="0 0 16 16" className="m-auto bi bi-unlock" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          :
          <div data-toggle="tooltip" data-placement="top" title="Show password" style={{ display: 'flex' }}>
            <svg xlinkTitle="Show password" onClick={() => setShow(true)} width="30px" height="20px" viewBox="0 0 16 16" className="m-auto bi bi-lock" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const NextIcon = () => (
  <svg width="30px" height="20px" viewBox="0 0 16 16" className="next-icon bi bi-arrow-right-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" />
...
const PrevIcon = () => (
  <svg width="30px" height="20px" viewBox="0 0 16 16" className="prev-icon bi bi-arrow-left-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" />
...
const SelectedFilters = () => (
  <svg width="20px" height="20px" viewBox="0 0 16 16" className="bi bi-exclamation" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
